...
module.exports = class inviteCommand extends Command {
    constructor() {
        super('invite', {
            ...
            category: 'invites',
            description: {
                content: "Vous permet d'ajouter, de supprimer, de réinitialiser ou de voir les invitations. \n\nadd - Ajoutez le nombre spécifié d'invitations aux membres mentionnés.\nremove - Supprime le nombre spécifié d'invitations du membre mentionné.\nreset - Supprimez toutes les invitations du membre mentionné.\nshow - Montre combien d'invitations vous ou le membre mentionné.",
